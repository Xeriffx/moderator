...
local Window = OrionLib:MakeWindow({IntroText = "executing",Name = "Potato Hub Version Doors Moderators Only", HidePremium = false, SaveConfig = true, ConfigFolder = "DoorsSex"})
...
local SpawnEntitiesTab = Window:MakeTab({
	Name = "Spawn Entities",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local Section = SpawnEntitiesTab:AddSection({
	Name = "Spawn One Entitie"
})

SpawnEntitiesTab:AddButton({
	Name = "Spawn Screech",
	Callback = function()
